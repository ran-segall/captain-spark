...
const OPTIONS = [
  ...
  { value: 'a_bit_easy', emoji: '🙂', label: 'A bit easy' },
  { value: 'just_right', emoji: '😅', label: 'Just right' },
  { value: 'kinda_hard', emoji: '🧠', label: 'Kinda hard' },
];

const LessonFeedback1: React.FC = () => {
  ...
  const handleContinue = async () => {
    ...
    setLoading(false);
    navigate(`/lesson/lesson-feedback-2?user=${userId}&lesson=${lessonId}`);
  };
...
export default LessonFeedback1; 